...
NIGHT_ID = ["notInBed", "011225", "051225"]  # nights to replay
    ...
    for i in tqdm(
        ...
        if len(accumulator) >= BATCH_SIZE:
            ...
            if processed_df is not None and not processed_df.empty:
                ...
                classifier.classify_once(night_id, timestamp=processed_df["datetime"].iloc[-1], use_refined=False)
